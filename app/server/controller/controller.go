...
// 获取get、post提交的string类型的参数 def表示默认值，取第一个，多余的丢弃
...
// 获取get、post提交的int类型的参数 def表示默认值，取第一个，多余的丢弃
...
// 获取get、post提交的int64类型的参数 def表示默认值，取第一个，多余的丢弃
...
// 获取get、post提交的float64类型的参数 def表示默认值，取第一个，多余的丢弃
